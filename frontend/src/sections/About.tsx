...
export const About: React.FC = () => {
  return (
    <section 
      id="about" 
      className="relative py-28 px-6 bg-[#0C0C0C] border-b border-white/5 overflow-hidden select-none"
    >
      ...
      {/* Torus / Donut */}
      <div className="absolute top-16 right-[15%] w-24 h-24 pointer-events-none animate-float opacity-25">
      ...
      {/* Cylinder / Capsule */}
      <div className="absolute bottom-16 left-[8%] w-16 h-24 pointer-events-none animate-float-reverse opacity-20">
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-20 relative z-10">
        ...
        <div className="flex flex-col items-center sm:items-start text-center sm:text-left gap-4">
          ...
          <h2 className="text-[10vw] sm:text-[7vw] lg:text-[5.5vw] font-kanit font-black uppercase tracking-tighter text-gradient leading-none select-none">
            ABOUT ME
          </h2>
        </div>
        ...
        <div className="max-w-5xl mx-auto sm:mx-0 w-full">
          <motion.p
            ...
            className="text-slate-300 text-lg sm:text-2xl font-light leading-relaxed tracking-wide font-sans text-center sm:text-left"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
          {cards.map((card, idx) => (
            <motion.div
              ...
              className="bg-[#111827] border border-white/5 rounded-2xl p-6 hover:bg-[#111827]/90 transition-all duration-300 flex flex-col gap-4"
            >
              <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center border border-white/10">
                {card.icon}
              </div>
              <div className="flex flex-col gap-2">
                <h3 className="text-base font-bold text-white font-kanit uppercase tracking-wide">
                  {card.title}
                </h3>
